window.onload = () => setTimeout(() => {
    ...
    var modal1 = document.querySelector("#modal"),
        ...
        message = document.querySelector("#content1"),
        modalhr = document.querySelector("#modalhr"),
        modalhr3 = document.querySelector("#modalhr3"),
        spanmodal = document.querySelector("#spanmodal"),
        spanmton = document.querySelector("#spanmodal button"),
        yes3 = document.querySelector("#yes"),
        no3 = document.querySelector("#no"),
        close9 = document.querySelector("#close"),
        modalcover = document.querySelector("#modalbgcover"),
